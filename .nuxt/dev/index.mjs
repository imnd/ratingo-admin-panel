...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseStatus, setResponseHeader, send, getRequestHeaders, getRequestURL, getResponseHeader, setResponseHeaders, removeResponseHeader, appendResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file://D:/domains/ratingo/admin-panel/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/domains/ratingo/admin-panel/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/domains/ratingo/admin-panel/node_modules/devalue/index.js';
import destr from 'file://D:/domains/ratingo/admin-panel/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://D:/domains/ratingo/admin-panel/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/domains/ratingo/admin-panel/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/domains/ratingo/admin-panel/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/domains/ratingo/admin-panel/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/domains/ratingo/admin-panel/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/domains/ratingo/admin-panel/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/domains/ratingo/admin-panel/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/domains/ratingo/admin-panel/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/domains/ratingo/admin-panel/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/domains/ratingo/admin-panel/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/domains/ratingo/admin-panel/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/domains/ratingo/admin-panel/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://D:/domains/ratingo/admin-panel/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/domains/ratingo/admin-panel/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://D:/domains/ratingo/admin-panel/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/domains/ratingo/admin-panel/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/domains/ratingo/admin-panel/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/domains/ratingo/admin-panel/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/domains/ratingo/admin-panel/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/domains/ratingo/admin-panel/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file://D:/domains/ratingo/admin-panel/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://D:/domains/ratingo/admin-panel/node_modules/pathe/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/domains/ratingo/admin-panel/node_modules/@unhead/shared/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/domains/ratingo/admin-panel/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/domains/ratingo/admin-panel"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/domains/ratingo/admin-panel/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/domains/ratingo/admin-panel/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/domains/ratingo/admin-panel/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/domains/ratingo/admin-panel/.data/kv"}));
...
const _1NXnquUGjOziwOfzUjgPwBqe2858eUrnaWDGTGBZUgg = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/domains/ratingo/admin-panel";
...
const _z5mvtKnE2gvHjRGjWw5o_tlTDhoRZCUWdESfV8rHDo = (nitroApp) => {
...
const plugins = [
  _1NXnquUGjOziwOfzUjgPwBqe2858eUrnaWDGTGBZUgg,
_z5mvtKnE2gvHjRGjWw5o_tlTDhoRZCUWdESfV8rHDo
];

const assets = {
  "/index.mjs": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"168d5-nIyS09wIbjczovL0yv3q1i0bgoE\"",
    "mtime": "2026-05-26T06:43:12.180Z",
    "size": 92373,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"570eb-T0We/qa1aa+TKfjnxpBAOtC51W4\"",
    "mtime": "2026-05-26T06:43:12.180Z",
    "size": 356587,
    "path": "index.mjs.map"
  }
...
const _K6gK_4 = eventHandler((event) => {
...
const _lazy_DpDqsg = () => Promise.resolve().then(function () { return analytics_get$1; });
const _lazy_xaKZp4 = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_4yqJKB = () => Promise.resolve().then(function () { return me_get$1; });
const _lazy_2wIlUI = () => Promise.resolve().then(function () { return reactivate_post$1; });
const _lazy_I87ABd = () => Promise.resolve().then(function () { return feedback_get$1; });
const _lazy_NEilkL = () => Promise.resolve().then(function () { return locations_get$1; });
const _lazy__lTW81 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _K6gK_4, lazy: false, middleware: true, method: undefined },
  { route: '/api/v1/analytics', handler: _lazy_DpDqsg, lazy: true, middleware: false, method: "get" },
  { route: '/api/v1/auth/login', handler: _lazy_xaKZp4, lazy: true, middleware: false, method: "post" },
  { route: '/api/v1/auth/me', handler: _lazy_4yqJKB, lazy: true, middleware: false, method: "get" },
  { route: '/api/v1/billing/reactivate', handler: _lazy_2wIlUI, lazy: true, middleware: false, method: "post" },
  { route: '/api/v1/feedback', handler: _lazy_I87ABd, lazy: true, middleware: false, method: "get" },
  { route: '/api/v1/locations', handler: _lazy_NEilkL, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy__lTW81, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy__lTW81, lazy: true, middleware: false, method: undefined }
];
...
const analytics_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const reactivate_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: reactivate_post
});
...
const feedback_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: feedback_get
});
...
const locations_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const getClientManifest = () => import('file://D:/domains/ratingo/admin-panel/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/domains/ratingo/admin-panel/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
