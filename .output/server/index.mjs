...
import { B as toNodeListener, h as destr, F as useRuntimeConfig, D as trapUnhandledNodeErrors, A as setupGracefulShutdown, E as useNitroApp } from './chunks/_/nitro.mjs';
import 'node:events';
import 'node:buffer';
import 'node:fs';
import 'node:path';
